      ...
      <div class="header">
        <section class="top-nav">
          ...
          <ul class="menu">
            ...
            <!-- <li :class="{ 'active': this.$route.path === '/projects' }">
              <router-link @click="liClicked" :class="{ 'active': this.$route.path === '/projects' }"
                class="custom__link text-decoration-none" to="/projects">Проекты</router-link>
            </li> -->
...
<script>
import NotifySVG from './NotifySVG'
import UserNotify from '../SigleComponents/UserNotify'
...
export default {
  ...
  methods: {
    ...
    changeShowNotify(){
      if(this.is_show && this.count_new_notify > 0){
