                ...
                <div v-if="step === 4" class="">
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-8 col-xxl-8 mx-auto">
                        ...
                        <p class="text-md-start text-center">
                            ...
                            Чтобы приступить к выполнению заданий, перейди в личный кабинет -> "Выбрать навыки".
                            Выбери компетенции, в которых ты силен.
                            <br>Все готово! Переходи в личный кабинет -> "Мои задания" и
                            приступай к участию.
                        </p>
                    </div>
