    ...
    <div class="row d-flex justify-content-between">
      <div class="col-lg-8">
        ...
        <div class="mb-4">
          ...
          <p class="mb-1">
            Главный организатор: Научно-исследовательский институт «<a href="www.cps.tver.ru"
              target="_blank">Центрпрограммсистем</a>»
          </p>
          <p>При поддержке:</p>
          <ul>
            <li><a href="https://fsp-russia.com/" target="_blank">Федерации спортивного программирования по Тверской
                области</a></li>
            <li><a href="https://xn--n1abebi.xn--80aaccp4ajwpkgbl4lpb.xn--p1ai/" target="_blank">Комитета по физической
                культуре и спорту Тверской области</a></li>
            <li><a href="https://xn--h1aakfqxm7b.xn--80aaccp4ajwpkgbl4lpb.xn--p1ai/" target="_blank">Министерства
                цифрового развития и информационных технологий Тверской области</a></li>
          </ul>
          <p>Соорганизаторы:</p>
          <ul>
