    ...
    <div class="row d-flex justify-content-between">
      <div class="col-lg-8">
        ...
        <p class="mb-3 text-center text-white bg-primary p-2 rounded">
          ...
          принять участие в очном этапе. Для этого переходи <router-link class="text-white"
            to="/cps-cup">сюда</router-link> и выбиреи
          номинации, в которых ты бы хотел принять участие.<br>
          Победители, которые прошли заочный этап, решив отборочные задания на сайте, будут получать существенно
          увеличенную выплату. Кстати, вы все еще можете принять участие в заочном этапе, задачи можно присылать
          до 31.10.23 включительно.
        </p>
