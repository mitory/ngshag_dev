<template>
    <div class='col-lg-6 mx-auto border rounded p-2'>
        ...
        <p>Не меньше <em>50 000 рублей*</em> для победителя в каждой из номинаций найдут своего чемпиона.
            Дополнительно победитель получит возможность трудоустройства по выбранному направлению.</p>
        <p><strong>Оргкомитетом принято решение о свободном доступе к конкурсу по первым пяти номинациям.</strong> Это
            значит, что каждый может выбрать номинацию и решить конкурсные задачи на очном этапе.</p>
